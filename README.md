...
- ## Two methods for Monte Carlo Method | Day 7
 ...
 - ## Linear function approximation in parameters | Day 19
   ...
   $$
   D=\left\{\left \langle s_{1},\upsilon _{1}^{\pi } \right \rangle,\left \langle s_{2},\upsilon _{2}^{\pi } \right \rangle,\cdots,\left \langle s_{T},\upsilon _{T}^{\pi } \right \rangle \right \}
   $$
